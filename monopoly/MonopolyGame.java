...
public class MonopolyGame {
	...
	public static void main(String[] args){
		...
		while (!commandString.equals(EXIT_GAME_STRING)) {
			...
			switch (actionStrings[0]) {
				...
				case "add": addCommand(actionStrings, playerMap, propertyList);
					break;
	...
	private static void tradePropertyCommand(String[] actionStrings,
		...
		tradePropertyBetweenPlayers(actionStrings[2], actionStrings[3], actionStrings[4],
				playerMap, null);
	}
	...
	private static void addPropertyCommand(String[] actionStrings,
		...
		tradePropertyBetweenPlayers(BANK_STRING, actionStrings[2], actionStrings[3], playerMap,
				propertyList);
	}
	...
	private static void addMoneyCommand(String[] actionStrings,
		...
		tradeMoneyBetweenPlayers(BANK_STRING, actionStrings[2], actionStrings[3], playerMap);
	}
	...
	private static Map<String, MonopolyProperty> initializeAllProperties() {
		...
		allProperties.put("mediterraneanavenue", new MonopolyProperty("Mediterranean Avenue",
				60, 0, MonopolyProperty.ColorGroup.DARK_PURPLE));
		allProperties.put("balticavenue", new MonopolyProperty("Baltic Avenue",
				80, 0, MonopolyProperty.ColorGroup.DARK_PURPLE));

		allProperties.put("orientalavenue", new MonopolyProperty("Oriental Avenue",
				100, 0, MonopolyProperty.ColorGroup.LIGHT_BLUE));
		allProperties.put("vermontavenue", new MonopolyProperty("Vermont Avenue",
				100, 0, MonopolyProperty.ColorGroup.LIGHT_BLUE));
		allProperties.put("connecticutavenue", new MonopolyProperty("Connecticut Avenue",
				120, 0, MonopolyProperty.ColorGroup.LIGHT_BLUE));

		allProperties.put("st.charlesplace", new MonopolyProperty("St. Charles Place",
				140, 0, MonopolyProperty.ColorGroup.PURPLE));
		allProperties.put("vermontavenue", new MonopolyProperty("States Avenue",
				140, 0, MonopolyProperty.ColorGroup.PURPLE));
		allProperties.put("virginiaavenue", new MonopolyProperty("Virginia Avenue",
				160, 0, MonopolyProperty.ColorGroup.PURPLE));

		allProperties.put("st.jamesplace", new MonopolyProperty("St. James Place",
				180, 0, MonopolyProperty.ColorGroup.ORANGE));
		allProperties.put("tennesseeavenue", new MonopolyProperty("Tennessee Avenue",
				180, 0, MonopolyProperty.ColorGroup.ORANGE));
		allProperties.put("newyorkavenue", new MonopolyProperty("New York Avenue",
				200, 0, MonopolyProperty.ColorGroup.ORANGE));

		allProperties.put("kentuckyavenue", new MonopolyProperty("Kentucky Avenue",
				220, 0, MonopolyProperty.ColorGroup.RED));
		allProperties.put("indianaavenue", new MonopolyProperty("Indiana Avenue",
				220, 0, MonopolyProperty.ColorGroup.RED));
		allProperties.put("illinoisavenue", new MonopolyProperty("Illinois Avenue",
				240, 0, MonopolyProperty.ColorGroup.RED));

		allProperties.put("atlanticavenue", new MonopolyProperty("Atlantic Avenue",
				260, 0, MonopolyProperty.ColorGroup.YELLOW));
		allProperties.put("ventnoravenue", new MonopolyProperty("Ventnor Avenue",
				260, 0, MonopolyProperty.ColorGroup.YELLOW));
		allProperties.put("marvingardens", new MonopolyProperty("Marvin Gardens",
				280, 0, MonopolyProperty.ColorGroup.YELLOW));

		allProperties.put("pacificavenue", new MonopolyProperty("Pacific Avenue",
				300, 0, MonopolyProperty.ColorGroup.GREEN));
		allProperties.put("northcarolinaavenue", new MonopolyProperty("North Carolina Avenue",
				300, 0, MonopolyProperty.ColorGroup.GREEN));
		allProperties.put("pennsylvaniaavenue", new MonopolyProperty("Pennsylvania Avenue",
				320, 0, MonopolyProperty.ColorGroup.GREEN));

		allProperties.put("parkplace", new MonopolyProperty("Park Place",
				350, 0, MonopolyProperty.ColorGroup.DARK_BLUE));
		allProperties.put("boardwalk", new MonopolyProperty("Boardwalk",
				400, 0, MonopolyProperty.ColorGroup.DARK_BLUE));
